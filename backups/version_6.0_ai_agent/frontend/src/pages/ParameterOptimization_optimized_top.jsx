...
import { Card, Form, Input, InputNumber, Button, Select, Alert, Row, Col, Typography } from 'antd';
import { RocketOutlined, LineChartOutlined, InfoCircleOutlined } from '@ant-design/icons';
    ...
    <div style={{ padding: '24px', maxWidth: '1600px', margin: '0 auto' }}>
      ...
      <div style={{ marginBottom: '32px' }}>
        <div style={{ display: 'flex', alignItems: 'center', marginBottom: '12px' }}>
          <LineChartOutlined style={{ marginRight: '16px', color: '#1890ff', fontSize: '32px' }} />
          <div>
            <h1 style={{ margin: 0, fontSize: '28px', fontWeight: '600', color: '#1f1f1f' }}>
              Parameter Optimization
            </h1>
            <div style={{ fontSize: '16px', color: '#595959', marginTop: '4px' }}>
        ...
        <div style={{ 
          ...
          <div style={{ display: 'flex', alignItems: 'flex-start', marginBottom: '12px' }}>
            <InfoCircleOutlined style={{ color: '#1890ff', fontSize: '18px', marginRight: '12px', marginTop: '2px' }} />
            <div>
              <div style={{ fontSize: '15px', fontWeight: '500', color: '#1f1f1f', marginBottom: '8px' }}>
                How it works
              </div>
              <div style={{ fontSize: '14px', color: '#595959', lineHeight: '1.5' }}>
                <div>• Select a strategy and define parameter ranges to test</div>
                <div>• The system will test all combinations and rank results by Sharpe ratio</div>
                <div>• Review best combinations, performance metrics, and parameter sensitivity</div>
                {combinationsPreview > 0 && (
                  <div style={{ marginTop: '8px', fontWeight: '500', color: '#1890ff' }}>
                    Current setup will test approximately <Text strong>{combinationsPreview}</Text> parameter combinations
                  </div>
                )}
              </div>
            </div>
          ...
          <div style={{ marginBottom: '28px' }}>
            ...
            <Row gutter={[24, 20]}>
              <Col xs={24} sm={12} md={6}>
                <Form.Item 
                  label={<span style={{ fontWeight: '500', fontSize: '14px' }}>Symbol</span>} 
                  name="symbol" 
              ...
              <Col xs={24} sm={12} md={6}>
                <Form.Item 
                  label={<span style={{ fontWeight: '500', fontSize: '14px' }}>Strategy</span>} 
                  name="strategy" 
              ...
              <Col xs={24} sm={12} md={6}>
                <Form.Item 
                  label={<span style={{ fontWeight: '500', fontSize: '14px' }}>Period</span>} 
                  name="period" 
              ...
              <Col xs={24} sm={12} md={6}>
                <Form.Item 
                  label={<span style={{ fontWeight: '500', fontSize: '14px' }}>Initial Capital ($)</span>} 
