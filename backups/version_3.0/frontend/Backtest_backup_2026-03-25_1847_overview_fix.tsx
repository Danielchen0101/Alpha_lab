...
const Backtest: React.FC = () => {
  ...
  const resultData = backtestResult ? [
    ...
    { 
      key: 'totalReturn', 
      metric: 'Total Return', 
      value: unifiedStats ? safeToFixed(unifiedStats.totalReturn, 2) : safeNumber(backtestResult.results?.totalReturn), 
    ...
    { 
      key: 'profitLoss', 
      metric: 'Profit / Loss', 
      value: unifiedStats ? `$${safeToFixed(unifiedStats.totalPnl, 2)}` : safeNumber(backtestResult.results?.profitLoss), 
    ...
    { 
      key: 'winRate', 
      metric: 'Win Rate', 
      value: unifiedStats ? safeToFixed(unifiedStats.winRate, 1) : safeNumber(backtestResult.results?.winRate), 
      description: 'Percentage of winning trades' 
    },
    { 
      key: 'trades', 
      metric: 'Trades', 
      value: unifiedStats ? unifiedStats.totalTrades : (backtestResult.results?.tradesList && backtestResult.results.tradesList.length > 0
    ...
    { 
      ...
      value: unifiedStats ? `$${safeToFixed(unifiedStats.avgPnl, 2)}` : `$${safeNumber(backtestResult.results?.avgReturnPerTrade).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`, 
    ...
    { 
      ...
      value: unifiedStats ? (Math.abs(unifiedStats.profitFactor - 99.00) < 0.01 ? 'N/A' : safeToFixed(unifiedStats.profitFactor, 2)) : (() => {
    ...
    { 
      key: 'expectancy', 
      metric: 'Expectancy', 
      value: unifiedStats ? safeToFixed(unifiedStats.expectancy, 2) : safeNumber(backtestResult.results?.expectancy), 
                    ...
                    <Row gutter={[16, 16]}>
                      <Col span={4}>
                        <Card size="small" style={{ textAlign: 'center' }}>
                          <Statistic
                            title="Total Return"
                            value={unifiedStats ? unifiedStats.totalReturn : (backtestResult.results.totalReturn || 0)}
                            precision={2}
                            suffix="%"
                            valueStyle={{
                              color: (unifiedStats ? unifiedStats.totalReturn : (backtestResult.results.totalReturn || 0)) >= 0 ? '#3f8600' : '#cf1322',
                              fontWeight: 'bold'
                            }}
                          />
                        </Card>
                      ...
                      <Col span={4}>
                        <Card size="small" style={{ textAlign: 'center' }}>
                          <Statistic
                            title="Win Rate"
                            value={unifiedStats ? unifiedStats.winRate : (backtestResult.results.winRate || 0)}
                            precision={1}
                            suffix="%"
                            valueStyle={{
                              color:
                                (unifiedStats ? unifiedStats.winRate : (backtestResult.results.winRate || 0)) >= 60
                                  ? '#3f8600'
                                  : (unifiedStats ? unifiedStats.winRate : (backtestResult.results.winRate || 0)) >= 40
                                  ? '#fa8c16'
                                  : '#cf1322',
                              fontWeight: 'bold'
                            }}
                      ...
                      <Col span={4}>
                        <Card size="small" style={{ textAlign: 'center' }}>
                          <Statistic
                            title="Total Trades"
                            value={
                              unifiedStats ? unifiedStats.totalTrades : (
