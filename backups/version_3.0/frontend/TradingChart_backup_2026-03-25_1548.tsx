...
const TradingChart: React.FC<TradingChartProps> = ({ data, height = 500, parameters }) => {
  ...
  const priceChartHeight = (hasVolumeData && showVolume) ? height * 0.60 : height * 0.80; // Price Chart稍微降低，给Volume更多空间
  const volumeChartHeight = (hasVolumeData && showVolume) ? height * 0.40 : 0; // Volume Chart增加高度
