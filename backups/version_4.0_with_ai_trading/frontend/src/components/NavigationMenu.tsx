  ...
  return (
    <div className={styles.navigationMenu}>
      ...
      >
        ...
        {createMenuItem('9', <BankOutlined />, 'Alpaca Paper Trading', '/alpaca-paper-trading')}
        {createMenuItem('10', <AreaChartOutlined />, t.navigation.analytics, '/analytics')}
        {createMenuItem('11', <RobotOutlined />, 'AI Trading', '/ai-trading')}
        {createMenuItem('12', <PieChartOutlined />, t.navigation.portfolio, '/portfolio')}
      </Menu>
    </div>
  );
};
