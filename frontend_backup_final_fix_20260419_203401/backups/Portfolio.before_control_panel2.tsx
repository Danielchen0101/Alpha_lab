  ...
  return (
    <div style={{ 
      ...
      <Row gutter={[16, 16]} style={{ marginBottom: '24px' }}>
        <Col xs={24} lg={16}>
          <div style={{ marginBottom: DESIGN_SYSTEM.spacing.lg }}>
            <h2 style={styles.sectionTitle}>Current Positions</h2>
            <Card style={styles.card}>
              <Table
                ...
                columns={[
                  ...
                  },
                  {
                    ...
                    width: 120,
                    align: 'right' as const,
                    render: (text: number) => text ? `$${text.toLocaleString('en-US', { minimumFractionDigits: 2 })}` : '—',
                  },
                  {
                    title: 'P&L',
                    dataIndex: 'pnl',
                    ...
                    render: (text: number, record: any) => {
                      const color = text >= 0 ? DESIGN_SYSTEM.colors.success : DESIGN_SYSTEM.colors.error;
                      return (
                        <div>
                          <div style={{ color, fontWeight: 500 }}>
                            {text >= 0 ? '+' : ''}${Math.abs(text).toLocaleString('en-US', { minimumFractionDigits: 2 })}
                          </div>
