                ...
                try:
                    ...
                    if stock_data and 'price' in stock_data and stock_data['price']:
                        results.append({
                            ...
                            'sector': profile_data.get('finnhubSector', 'Unknown') if profile_data else 'Unknown',
...
def get_stock_data_for_scanner(symbol):
    ...
    try:
        ...
        try:
            ...
            if alpaca_data and not alpaca_error and alpaca_data.get('price'):
                ...
                stock_data = {
                    ...
                    'volume': alpaca_volume if alpaca_volume is not None else 0,
                    'dataSource': 'Alpaca'
                }
            else:
                # 回退到Finnhub
        ...
        try:
            ...
            # 确保Sector信息
            if not profile_data.get('finnhubSector') and not profile_data.get('sector'):
                # 尝试从其他来源获取Sector信息
                ...
                if sector_info:
                    ...
                    print(f'[Sector Info] {symbol}: 从备选来源获取Sector: {sector_info}')
                else:
