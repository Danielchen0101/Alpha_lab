    ...
    if match:
        ...
        if return_match:
            ...
            if '"result"' in return_expr or "'result'" in return_expr:
                print("OK: run_backtest 返回包含 'result' 字段")
            else:
                print("ERROR: run_backtest 返回不包含 'result' 字段")
            ...
            print("ERROR: 未找到 return jsonify 语句")
    else:
        print("ERROR: 未找到 run_backtest 函数")
...
def check_optimization_response_structure():
    ...
    if match:
        ...
        if return_match:
            ...
            # 检查是否包含 result 字段
            if '"result"' in return_expr or "'result'" in return_expr:
                print("OK: run_parameter_optimization 返回包含 'result' 字段")
            else:
                print("ERROR: run_parameter_optimization 返回不包含 'result' 字段")
        ...
        print("ERROR: 未找到 run_parameter_optimization 函数")
