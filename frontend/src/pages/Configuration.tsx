...
import { Card, Typography, Button, Form, Input, Select, Tag, message, Divider, Row, Col } from 'antd';
import {
  ArrowLeftOutlined, CloudServerOutlined, ApiOutlined, RobotOutlined,
  CheckCircleOutlined, CloseCircleOutlined, EyeInvisibleOutlined, EyeTwoTone
    ...
    <div style={{ maxWidth: 900, margin: '0 auto' }}>
      ...
      <Card style={cardStyle}>
        ...
        <Form form={alpacaForm} layout="vertical" onFinish={handleSaveAlpaca} initialValues={{ environment: 'paper' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'flex-end', gap: 8 }}>
            <Button onClick={handleTestAlpaca} loading={alpacaTestLoading} icon={<CheckCircleOutlined />}>Test Connection</Button>
            <Button type="primary" htmlType="submit" loading={alpacaLoading}>Save Alpaca Settings</Button>
          </div>
        </Form>
      </Card>
      ...
      <Card style={cardStyle}>
        ...
        <Form form={finnhubForm} layout="vertical" onFinish={handleSaveFinnhub}>
          ...
          <div style={{ display: 'flex', justifyContent: 'flex-end', gap: 8 }}>
            <Button onClick={handleTestFinnhub} loading={finnhubTestLoading} icon={<CheckCircleOutlined />}>Test Connection</Button>
            <Button type="primary" htmlType="submit" loading={finnhubLoading}>Save Finnhub Settings</Button>
          </div>
        </Form>
      </Card>
      ...
      <Card style={cardStyle}>
        ...
        <Form form={aiForm} layout="vertical" onFinish={handleSaveAi} initialValues={{ provider: 'DeepSeek', model: 'deepseek-chat' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'flex-end', gap: 8 }}>
            <Button onClick={handleTestAi} loading={aiTestLoading} icon={<CheckCircleOutlined />}>Test Connection</Button>
            <Button type="primary" htmlType="submit" loading={aiLoading}>Save AI Settings</Button>
          </div>
        </Form>
      </Card>
    </div>
