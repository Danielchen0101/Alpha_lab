    ...
    <div className="landing-container">
      ...
      <nav className={`nav-header ${scrolled ? 'scrolled' : ''}`}>
        ...
        <div className="nav-actions">
          <Button type="text" onClick={toggleLanguage} style={{ color: '#94a3b8', fontWeight: 600, display: 'inline-flex', alignItems: 'center', gap: 4, fontSize: 13 }} aria-label="Switch Language"><GlobalOutlined aria-hidden="true" style={{ fontSize: 14 }} /> {language === 'zh-CN' ? '中文' : 'EN'}</Button>
