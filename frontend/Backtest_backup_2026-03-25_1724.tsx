      ...
      if (TEST_MODE && (!result || !result.results || !result.results.tradesList || result.results.tradesList.length <= 1)) {
        ...
        result = {
          ...
          results: {
            ...
            trades: 8, // 模拟8个交易
            tradesList: [
              { entryDate: '2025-01-15', exitDate: '2025-01-20', entryPrice: 150.25, exitPrice: 152.50, pnl: 225, returnPct: 1.5, action: 'BUY', quantity: 100 },
              { entryDate: '2025-02-10', exitDate: '2025-02-15', entryPrice: 155.75, exitPrice: 154.25, pnl: -150, returnPct: -0.96, action: 'SELL', quantity: 100 },
              { entryDate: '2025-03-05', exitDate: '2025-03-12', entryPrice: 152.00, exitPrice: 156.80, pnl: 480, returnPct: 3.16, action: 'BUY', quantity: 100 },
              { entryDate: '2025-04-18', exitDate: '2025-04-25', entryPrice: 158.40, exitPrice: 156.20, pnl: -220, returnPct: -1.39, action: 'SELL', quantity: 100 },
              { entryDate: '2025-05-22', exitDate: '2025-05-29', entryPrice: 154.80, exitPrice: 159.60, pnl: 480, returnPct: 3.10, action: 'BUY', quantity: 100 },
              { entryDate: '2025-06-14', exitDate: '2025-06-21', entryPrice: 160.25, exitPrice: 158.75, pnl: -150, returnPct: -0.94, action: 'SELL', quantity: 100 },
              { entryDate: '2025-07-08', exitDate: '2025-07-15', entryPrice: 157.50, exitPrice: 162.25, pnl: 475, returnPct: 3.02, action: 'BUY', quantity: 100 },
              { entryDate: '2025-08-03', exitDate: '2025-08-10', entryPrice: 163.00, exitPrice: 161.40, pnl: -160, returnPct: -0.98, action: 'SELL', quantity: 100 }
            ],
            winRate: 50.0, // 4赢4输
            profitLoss: 980, // 总P&L
            avgReturnPerTrade: 122.5 // 平均P&L
          }
        };
